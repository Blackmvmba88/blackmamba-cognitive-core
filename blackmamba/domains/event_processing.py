...
class EventProcessingDomain(DomainProcessor):
    ...
    async def synthesize(
        ...
        synthesis_data = {
            ...
            "summary": f"Evento {event_type} analizado con prioridad {analysis_results['metrics']['priority']}",
        }
        
        confidence = 0.9 if analysis_results["metrics"]["priority"] in ["high", "critical"] else 0.75
